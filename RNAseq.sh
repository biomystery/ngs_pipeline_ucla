...
echo -e "############################################################"| tee -a $LOG_FILE
echo -e "1.2 `date` starting decompressing " | tee -a $LOG_FILE
...
echo -e "############################################################"| tee -a $LOG_FILE
echo -e "1.3 `date` starting converting qseq to fastq " | tee -a $LOG_FILE
...
echo -e "############################################################"| tee -a $LOG_FILE
echo -e "1.4 `date` starting demultiplex " | tee -a $LOG_FILE
...
echo -e "############################################################"| tee -a $LOG_FILE
echo -e "1.5  `date` start merge fastq " | tee -a $LOG_FILE
...
wait;echo -e "(`date`) 1.5 demultiplex finished" | tee -a $LOG_FILE

echo -e "############################################################"| tee -a $LOG_FILE
echo -e "1.6 `date` start remove unmatched fastq " | tee -a $LOG_FILE
...
echo -e "(`date`) Step 1.7 QC consolidated fastq Finshed!" | tee -a $LOG_FILE
...
echo -e "############################################################" | tee -a $LOG_FILE
echo -e "(`date`) Starting Part 2: Alignment" | tee -a $LOG_FILE
